...
--Rank XP Requirement Corner
		...
		local DOWDivisionBox = vgui.Create( "DDropListBox", OWMenu )
                ...
                DOWDivisionBox:AddChoice( "PRESERVE - Heavy Prison Unit", 9 )
                DOWDivisionBox:AddChoice( "STAR - Pilot", 10 )
                DOWDivisionBox:AddChoice( "ANVIL - Team Leader", 11 )
                DOWDivisionBox:AddChoice( "ZONE - Hazard Unit", 12 )
                DOWDivisionBox:AddChoice( "K9S - Assassin", 13 )
